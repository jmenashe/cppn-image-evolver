...
/**
 * enumerated type constant for an ANJI ANN
 */
...
/**
 * enumerated type constant for an ANJI CPPN
 */
public final static String PICBREEDER_TYPE = "picBreeder.cppn";
...
//	} else if ( PICBREEDER_TYPE.equalsIgnoreCase( type )) {
//		result = CPPNFactoryInstance.get().createNetwork(ch);
