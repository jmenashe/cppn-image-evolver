...
public class Configuration implements java.io.Serializable {
	...
	private static int m_minAge = 250;
	 ...
	 */
	private List<ReproductionOperator> reproductionOperators = new ArrayList<ReproductionOperator>();
	...
	public void setMinChromosomeAge(int aNewMinAge) {
		m_minAge = Math.max(Math.min(aNewMinAge, Integer.MAX_VALUE), 0);
	}
	...
	public synchronized void verifyStateIsValid() throws InvalidConfigurationException {
		...
		for (ReproductionOperator oper : getReproductionOperators()) {
